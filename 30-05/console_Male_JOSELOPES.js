...
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].value='5803005'
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].dispatchEvent(event)

// Preenche o email
document.getElementsByTagName("form")[0].querySelectorAll('input')[7].value='AJ580305505@outlook.com'

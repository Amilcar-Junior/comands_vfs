...
// Preenche o nome
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].value='JOAO JOSE'
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].dispatchEvent(event)

// Preenche o sobrenome
document.getElementsByTagName("form")[0].querySelectorAll('input')[1].value='JORGE FURTADO'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[2].value='25/11/1981'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].value='PA377444'
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].dispatchEvent(event)

// Preenche a data de expiração
document.getElementsByTagName("form")[0].querySelectorAll('input')[4].value='04/09/2028'

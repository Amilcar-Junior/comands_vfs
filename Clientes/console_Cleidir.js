...
// Preenche o nome
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].value='CLEIDIR ALEX'
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].dispatchEvent(event)

// Preenche o sobrenome
document.getElementsByTagName("form")[0].querySelectorAll('input')[1].value='BRITO DOS SANTOS'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[2].value='29/10/1994'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].value='PA401235'
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].dispatchEvent(event)

// Preenche a data de expiracao
document.getElementsByTagName("form")[0].querySelectorAll('input')[4].value='10/12/2028'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].value='5803043'
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].dispatchEvent(event)

// Preenche o email
document.getElementsByTagName("form")[0].querySelectorAll('input')[7].value='AJ580305543@outlook.com'

...
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].value='EVARISTO LENINE'
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].dispatchEvent(event)


document.getElementsByTagName("form")[0].querySelectorAll('input')[1].value='DA MOURA LANDIN'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[2].value='09/07/1985'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].value='PA344133'
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].dispatchEvent(event)

document.getElementsByTagName("form")[0].querySelectorAll('input')[4].value='16/04/2028'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].value='9553365'
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].dispatchEvent(event)

document.getElementsByTagName("form")[0].querySelectorAll('input')[7].value='hb87293219@outlook.pt'

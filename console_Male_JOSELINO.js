...
// Preenche o nome
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].value='JOSE LINO'
document.getElementsByTagName("form")[0].querySelectorAll('input')[0].dispatchEvent(event)

// Preenche o sobrenome
document.getElementsByTagName("form")[0].querySelectorAll('input')[1].value='MOREIRA FERNANDES'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[2].value='02/01/1989'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].value='PA363727'
document.getElementsByTagName("form")[0].querySelectorAll('input')[3].dispatchEvent(event)

// Preenche a data de expiracao
document.getElementsByTagName("form")[0].querySelectorAll('input')[4].value='12/06/2028'
...
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].value='5803017'
document.getElementsByTagName("form")[0].querySelectorAll('input')[6].dispatchEvent(event)

// Preenche o email
document.getElementsByTagName("form")[0].querySelectorAll('input')[7].value='AJ580305517@outlook.com'
